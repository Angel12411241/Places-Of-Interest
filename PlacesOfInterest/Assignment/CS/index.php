...
<body>
    <div class="main">
        ...
        <div class="content">
            <h1>The City of <span class="span">Plovdiv</span><br>History</h1>
            <p class="par">                <?php 
                $sql = "SELECT * FROM cityinfo WHERE id=1;";
                ...
                if ($resultCheck>0){
                    ...
                    ?>   <td> <?php echo $row['history']; ?>  </td><br><br>
                         ...
                         <h2 class="population"><td> Lattitude : <?php echo $row['lat'];  ?></td></h2>
                         <h2 class="population"><td> Longtitude: <?php echo $row['long'];  ?></td></h2>
                <?php
                    }
                }
                ?>  </p>
